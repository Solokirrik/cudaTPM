...
int main() {
	...
	thrust::transform(hostVectorA.begin(), hostVectorA.end(),hostVectorB.begin(), hostVectorC.begin(), thrust::plus<int>());
	...
	thrust::transform(deviceVectorA.begin(), deviceVectorA.end(), deviceVectorB.begin(), deviceVectorC.begin(), thrust::plus<int>());
